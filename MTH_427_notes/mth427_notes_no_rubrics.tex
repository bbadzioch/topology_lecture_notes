...
$A = \bigcup_{n=1}^{\infty} A_{n}$ is compact and connected.  
...
Let $X$ be a non-compact, locally compact space and let $j\colon X \to X^{+}$ be the one-point compactification 
